...
HF_TOKEN = "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"
...
def build_instruction_rules():
    return (
        ...
        "2. ใช้ข้อมูลใน 'บริบทข้อมูล' เป็นหลัก\n"
        "3. หากบริบทข้อมูลระบุว่าไม่พบข้อมูล ให้ตอบอย่างสุภาพว่า 'ขออภัยครับ ข้อมูลส่วนนี้ยังไม่ได้ระบุไว้ในระบบของผมครับ'\n"
        "4. ห้ามตอบว่า 'นอกเรื่อง' หรือปัดคำถามทิ้ง\n"
        "5. ความยาวคำตอบ 15–50 คำ\n"
        "6. ตอบเป็นภาษาไทย ห้ามใช้จุด (.) และห้ามเว้นวรรคแปลก ๆ\n"
        "7. ระบุ ชื่อ-นามสกุล หรือชื่อวิชา ลงไปในคำตอบทุกครั้ง\n"
        "8. ตอบคำถามให้เข้าใจง่าย และถ้าเป็นคำถามเกี่ยวกับอาชีพให้ระบุตำแหน่งงานเป็นรายการ เช่น IoT Engineer, Embedded Engineer"
    )
